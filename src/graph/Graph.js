...
export class Graph extends mxGraph {
  static getStyleDict(cell) {
    return compact(cell.getStyle().split(';'))
      .reduce((acc, item) => {
  ...
  constructor(container, nodeStyle) {
    super(container)
    this.selfNodeStyle = nodeStyle
    this._init()
  }
  ...
  _putVertexStyle() {
    ...
    const nodeStyle = {
      ...
      [mxConstants.STYLE_IMAGE_WIDTH]: '70',
      [mxConstants.STYLE_IMAGE_HEIGHT]: '70',
...
export const genGraph = (container, nodeStyle = {}) => {
  graph = new Graph(container, nodeStyle)
  return graph
}
